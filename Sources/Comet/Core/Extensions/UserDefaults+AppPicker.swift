...
extension UserDefaults {
    ...
    internal func setAppProxies(_ appProxies: [ApplicationWorkspace.ApplicationProxy]?, forKey key: String) {
        do {
    ...
    internal func appProxies(forKey key: String) -> [ApplicationWorkspace.ApplicationProxy]? {
